...
const ComingSoon = () => {
  return (
    <div className="relative flex flex-col items-center justify-center min-h-[90vh] overflow-hidden bg-backg text-center px-4 sm:px-6 md:px-8">
      ...
      <motion.p
        className="mt-4 sm:mt-5 text-base sm:text-lg md:text-2xl text-[rgba(255,255,255,0.8)] font-medium"
      ...
      <motion.div
        className="mt-6 sm:mt-8 w-32 sm:w-40 h-[3px] bg-main rounded-full"
        initial={{ width: 0 }}
        animate={{ width: "10rem" }}
