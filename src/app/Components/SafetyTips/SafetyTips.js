...
const SafetyTips = () => {
  ...
  return (
    <section className="py-12 px-4 sm:px-6 md:px-8 bg-gradient-to-b from-[#f8f5ff] to-white">
      <div className="max-w-6xl mx-auto">

        {/* Top CTA box */}
        <div className="bg-[#ede7ff] rounded-3xl p-6 sm:p-8 md:p-10 flex flex-col sm:flex-row items-center justify-between shadow-md mb-10 sm:mb-12 gap-6">
          <div className="sm:w-2/3 text-center sm:text-left">
            <h2 className="text-lg sm:text-xl md:text-3xl font-semibold text-[#4B2EFF] leading-snug mb-3">
          ...
          <div className="text-4xl sm:text-6xl md:text-8xl text-[#7C4DFF]/25 font-bold">
            🚀
          </div>
        </div>
          ...
          {tips.map((tip, index) => (
            ...
            >
              <div className="flex items-center gap-3 mb-2 sm:mb-3">
                <div className="p-2 sm:p-3 bg-[#f0eaff] rounded-xl">{tip.icon}</div>
