        ...
        <div className="md:hidden mt-3 bg-white rounded-xl p-4 flex flex-col gap-3 shadow-lg transition-all duration-300">
          ...
          {!isLoggedIn && (
            <Link href="Login" onClick={() => setIsMobileMenuOpen(false)}>
              <button className="w-full bg-gradient-to-r from-purple-400 via-pink-500 to-indigo-500 text-white font-semibold py-2 rounded-xl transition-all duration-200">
                Login
              </button>
            </Link>
          )}
